...
export class SchoolsViewProblem {
  ...
  /**
   * Configura los bloques al workspace de trabajo, agregar configuracion de bloques personalizados
   */
  ...
  /**
   * Dar funcionalidad a los bloques predefinidos y bloques personalizados
   */
