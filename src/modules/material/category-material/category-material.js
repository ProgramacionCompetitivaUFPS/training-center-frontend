...
// servicio de backend de material (Material), servicio de Router (Router), servicio de Categorias (Categories)
@inject(Alert, Auth, Materials, Router, Categories)
...
export class CategoryMaterial {
   ...
   */
  constructor (alertService, authService, materialService, routerService, categoryService) {
    ...
    this.page = 1
    this.totalPages = 1
    this.typeCategory = Enums.typeCategory.university
  }
