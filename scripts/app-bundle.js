...
define('modules/problems/view-problem/view-problem',['exports', 'aurelia-framework', 'aurelia-router', 'config/config', 'models/models', 'services/services'], function (exports, _aureliaFramework, _aureliaRouter, _config, _models, _services) {
  ...
  var ViewProblem = exports.ViewProblem = (_dec = (0, _aureliaFramework.inject)(_services.Alert, _services.Problems, _aureliaRouter.Router), _dec(_class = function () {
...
define('modules/syllabus/syllabus-detail/syllabus-detail',['exports', 'aurelia-framework', 'config/config', 'models/models', 'services/services'], function (exports, _aureliaFramework, _config, _models, _services) {
  'use strict';
  ...
  var SyllabusDetail = exports.SyllabusDetail = (_dec = (0, _aureliaFramework.inject)(_services.Alert, _services.Auth, _services.Syllabuses), _dec(_class = function () {
