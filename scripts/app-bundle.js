...
define('services/problems',['exports', 'config/config', 'services/http', 'services/jwt'], function (exports, _config, _http, _jwt) {
  ...
  var Problems = exports.Problems = function () {
    ...
    Problems.prototype.getCategoryProblems = function getCategoryProblems(id) {
      ...
      return this.httpService.httpClient.fetch(_config.API.endpoints.categoryProblems.replace('{1}', id), {
        method: 'get',
        headers: {
          'Authorization': 'Bearer ' + this.jwtService.token,
          'Content-Type': 'application/json'
...
define('services/services',['exports', './alert', './auth', './http', './jwt', './problems', './materials'], function (exports, _alert, _auth, _http, _jwt, _problems, _materials) {
  'use strict';
