...
define('models/models',['exports', './category', './material', './problem', './syllabus', './user-login', './user-reset', './user-signin'], function (exports, _category, _material, _problem, _syllabus, _userLogin, _userReset, _userSignin) {
  'use strict';
...
define('modules/syllabus/syllabus-detail/syllabus-detail',["exports"], function (exports) {
  "use strict";
  ...
  var SyllabusDetail = exports.SyllabusDetail = function SyllabusDetail() {
