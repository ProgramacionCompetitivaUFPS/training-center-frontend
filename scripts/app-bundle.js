...
define('models/models',['exports', './category', './material', './problem', './user-login', './user-reset', './user-signin'], function (exports, _category, _material, _problem, _userLogin, _userReset, _userSignin) {
  'use strict';
...
define('services/syllabuses',['exports', 'config/config', 'services/http', 'services/jwt'], function (exports, _config, _http, _jwt) {
  'use strict';
...
define('modules/syllabus/syllabus',['exports', 'config/config', 'services/services'], function (exports, _config, _services) {
  'use strict';
  ...
  var Syllabus = exports.Syllabus = function () {
    Syllabus.inject = function inject() {
      return [_services.Alert, _services.Auth, _services.Syllabuses];
    };

    function Syllabus(alertService, authService, syllabusService) {
    ...
    Syllabus.prototype.created = function created() {
      if (this.authService.isStudent()) this.getEnrolledSyllabuses();
      this.getSyllabuses();
    };

    Syllabus.prototype.getSyllabuses = function getSyllabuses() {
      var _this = this;
    ...
    Syllabus.prototype.getEnrolledSyllabuses = function getEnrolledSyllabuses() {};
