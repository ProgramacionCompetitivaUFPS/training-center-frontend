  ...
  var Admin = exports.Admin = function () {
    ...
    Admin.prototype.createUser = function createUser() {
      ...
      if (!this.newUser.isValid()) {
        ...
        this.authService.createSuperUser(this.newUser).then(function () {
          _this2.alertService.showMessage(_config.MESSAGES.superUserCreated);
        }).catch(function (error) {
          if (error.status === 400) {
            _this2.alertService.showMessage(_config.MESSAGES.superUserWrongData);
          } else {
    ...
    Admin.prototype.approveMaterial = function approveMaterial(id) {
      ...
      this.materialService.approve(id).then(function () {
        _this3.alertService.showMessage(_config.MESSAGES.materialApproved);
        _this3.getMaterials();
      }).catch(function () {
...
define('modules/material/public-material/public-material',['exports', 'aurelia-framework', 'aurelia-router', 'config/config', 'models/models', 'services/services'], function (exports, _aureliaFramework, _aureliaRouter, _config, _models, _services) {
  ...
  var PublicMaterial = exports.PublicMaterial = (_class = function () {
  ...
  }(), (_descriptor = _applyDecoratedDescriptor(_class.prototype, 'page', [_aureliaFramework.observable], {
    enumerable: true,
    initializer: null
  })), _class);
});
...
define('modules/syllabus/home-syllabus/home-syllabus',['exports', 'config/config', 'models/models', 'services/services'], function (exports, _config, _models, _services) {
  ...
  var HomeSyllabus = exports.HomeSyllabus = function () {
    ...
    HomeSyllabus.prototype.getSyllabuses = function getSyllabuses() {
      ...
      this.syllabusService.getSyllabuses(this.syllabusToShow, this.page, coachId).then(function (data) {
    ...
    HomeSyllabus.prototype.setPagination = function setPagination() {
      this.pagination = [];
      if (this.page === this.totalPages && this.page - 4 > 0) {
        this.pagination.push(this.page - 4);
        this.pagination.push(this.page - 3);
    ...
    HomeSyllabus.prototype.goToFirstPage = function goToFirstPage() {
      this.goToPage(1);
    };

    HomeSyllabus.prototype.goToLastPage = function goToLastPage() {
      this.goToPage(this.totalPages);
    };

    HomeSyllabus.prototype.goToPrevPage = function goToPrevPage() {
      if (this.page > 1) {
        this.goToPage(this.page - 1);
      }
    };

    HomeSyllabus.prototype.goToNextPage = function goToNextPage() {
      if (this.page < this.totalPages) {
        this.goToPage(this.page + 1);
      }
    };

    HomeSyllabus.prototype.goToPage = function goToPage(page) {
      if (page !== this.page) {
        this.page = page;
        this.getSyllabuses();
      }
