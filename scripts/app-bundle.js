  ...
  var Assignment = exports.Assignment = function () {
    ...
    Assignment.prototype.adjuntProblems = function adjuntProblems(problems) {
      ...
      for (var _i = 0; _i < 5; _i++) {
        this.problemsLoaded.push(new _problem.Problem(_i, 'Title ' + _i, 'Titulo ' + _i, 5 - _i));
      }
    };
...
define('models/models',['exports', './assignment', './category', './material', './problem', './syllabus', './user-login', './user-reset', './user-signin'], function (exports, _assignment, _category, _material, _problem, _syllabus, _userLogin, _userReset, _userSignin) {
  'use strict';
...
define('services/services',['exports', './alert', './auth', './http', './jwt', './materials', './problems', './syllabuses'], function (exports, _alert, _auth, _http, _jwt, _materials, _problems, _syllabuses) {
  'use strict';
...
define('services/syllabuses',['exports', 'config/config', 'models/models', 'services/http', 'services/jwt'], function (exports, _config, _models, _http, _jwt) {
  'use strict';
  ...
  var Syllabuses = exports.Syllabuses = function () {
    Syllabuses.inject = function inject() {
      return [_http.Http, _jwt.Jwt];
    };
...
define('modules/admin/admin',['exports', 'config/config', 'models/models', 'services/services'], function (exports, _config, _models, _services) {
  'use strict';
  ...
  var Admin = exports.Admin = function () {
    Admin.inject = function inject() {
      return [_services.Alert, _services.Auth, _services.Materials];
    };
    ...
    Admin.prototype.getMaterials = function getMaterials() {
      ...
      this.materialService.getPendingMaterial(this.page, this.noProblemsToShow, this.sortDisplay === 'Nombre' ? 'name' : undefined, this.byDisplay === 'Ascendente' ? 'asc' : 'desc').then(function (data) {
        _this.materials = [];
    ...
    Admin.prototype.setSort = function setSort(sort) {
      this.sortDisplay = sort;
      this.getMaterials();
    };

    Admin.prototype.setBy = function setBy(by) {
      this.byDisplay = by;
      this.getMaterials();
    };

    Admin.prototype.setNoProblemsToShow = function setNoProblemsToShow(number) {
      this.noProblemsToShow = number;
      this.getMaterials();
    };

    Admin.prototype.setPagination = function setPagination() {
      this.pagination = [];
    ...
    Admin.prototype.goToFirstPage = function goToFirstPage() {
      this.goToPage(1);
    };

    Admin.prototype.goToLastPage = function goToLastPage() {
      this.goToPage(this.totalPages);
    };

    Admin.prototype.goToPrevPage = function goToPrevPage() {
      if (this.page > 1) {
        this.goToPage(this.page - 1);
      }
    };

    Admin.prototype.goToNextPage = function goToNextPage() {
      if (this.page < this.totalPages) {
        this.goToPage(this.page + 1);
      }
    };

    Admin.prototype.goToPage = function goToPage(page) {
      if (page !== this.page) {
        this.page = page;
        this.getMaterials();
      }
    ...
    Admin.prototype.approveMaterial = function approveMaterial(id) {
      ...
      this.materialService.approve(id).then(function () {
        _this2.alertService.showMessage(_config.MESSAGES.materialApproved);
        _this2.getMaterials();
      }).catch(function () {
    ...
    Admin.prototype.removeMaterial = function removeMaterial() {
      ...
      this.materialService.remove(this.materialToRemove).then(function () {
        _this3.alertService.showMessage(_config.MESSAGES.materialDeleted);
        _this3.getMaterials();
...
define('modules/material/category-material/category-material',['exports', 'aurelia-router', 'config/config', 'models/models', 'services/services'], function (exports, _aureliaRouter, _config, _models, _services) {
  'use strict';
  ...
  var CategoryMaterial = exports.CategoryMaterial = function () {
    CategoryMaterial.inject = function inject() {
      return [_services.Alert, _services.Auth, _services.Materials, _aureliaRouter.Router];
    };
    ...
    CategoryMaterial.prototype.getMaterial = function getMaterial() {
      ...
      this.materialService.getCategoryMaterial(this.id, this.page, this.noProblemsToShow, this.sortDisplay === 'Nombre' ? 'name' : undefined, this.byDisplay === 'Ascendente' ? 'asc' : 'desc').then(function (data) {
        _this.materials = [];
    ...
    CategoryMaterial.prototype.setSort = function setSort(sort) {
      this.sortDisplay = sort;
      this.getMaterial();
    };

    CategoryMaterial.prototype.setBy = function setBy(by) {
      this.byDisplay = by;
      this.getMaterial();
    };

    CategoryMaterial.prototype.setNoProblemsToShow = function setNoProblemsToShow(number) {
      this.noProblemsToShow = number;
      this.getMaterial();
    };

    CategoryMaterial.prototype.setPagination = function setPagination() {
      this.pagination = [];
      if (this.page === this.totalPages && this.page - 4 > 0) {
        this.pagination.push(this.page - 4);
        this.pagination.push(this.page - 3);
    ...
    CategoryMaterial.prototype.goToFirstPage = function goToFirstPage() {
      this.goToPage(1);
    };

    CategoryMaterial.prototype.goToLastPage = function goToLastPage() {
      this.goToPage(this.totalPages);
    };

    CategoryMaterial.prototype.goToPrevPage = function goToPrevPage() {
      if (this.page > 1) {
        this.goToPage(this.page - 1);
      }
    };

    CategoryMaterial.prototype.goToNextPage = function goToNextPage() {
      if (this.page < this.totalPages) {
        this.goToPage(this.page + 1);
      }
    };

    CategoryMaterial.prototype.goToPage = function goToPage(page) {
      if (page !== this.page) {
        this.page = page;
        this.getMaterial();
      }
...
define('modules/material/public-material/public-material',['exports', 'aurelia-router', 'config/config', 'models/models', 'services/services'], function (exports, _aureliaRouter, _config, _models, _services) {
  'use strict';
  ...
  var PublicMaterial = exports.PublicMaterial = function () {
    PublicMaterial.inject = function inject() {
      return [_services.Alert, _services.Auth, _services.Materials];
    };
    ...
    PublicMaterial.prototype.getMaterial = function getMaterial() {
      ...
      this.materialService.getPublicMaterial(this.page, this.noProblemsToShow, this.sortDisplay === 'Nombre' ? 'name' : undefined, this.byDisplay === 'Ascendente' ? 'asc' : 'desc').then(function (data) {
        _this.materials = [];
        _this.totalPages = data.meta.totalPages;
        if (_this.totalPages !== 0) {
          for (var i = 0; i < data.data.length; i++) {
    ...
    PublicMaterial.prototype.setSort = function setSort(sort) {
      this.sortDisplay = sort;
      this.getMaterial();
    };

    PublicMaterial.prototype.setBy = function setBy(by) {
      this.byDisplay = by;
      this.getMaterial();
    };

    PublicMaterial.prototype.setNoProblemsToShow = function setNoProblemsToShow(number) {
      this.noProblemsToShow = number;
      this.getMaterial();
    };

    PublicMaterial.prototype.setPagination = function setPagination() {
      this.pagination = [];
      if (this.page === this.totalPages && this.page - 4 > 0) {
        this.pagination.push(this.page - 4);
        this.pagination.push(this.page - 3);
    ...
    PublicMaterial.prototype.goToFirstPage = function goToFirstPage() {
      this.goToPage(1);
    };

    PublicMaterial.prototype.goToLastPage = function goToLastPage() {
      this.goToPage(this.totalPages);
    };

    PublicMaterial.prototype.goToPrevPage = function goToPrevPage() {
      if (this.page > 1) {
        this.goToPage(this.page - 1);
      }
    };

    PublicMaterial.prototype.goToNextPage = function goToNextPage() {
      if (this.page < this.totalPages) {
        this.goToPage(this.page + 1);
      }
    };

    PublicMaterial.prototype.goToPage = function goToPage(page) {
      if (page !== this.page) {
        this.page = page;
        this.getMaterial();
      }
...
define('modules/material/specific-material/specific-material',['exports', 'aurelia-router', 'config/config', 'models/models', 'services/services'], function (exports, _aureliaRouter, _config, _models, _services) {
  'use strict';
  ...
  var SpecificMaterial = exports.SpecificMaterial = function () {
    SpecificMaterial.inject = function inject() {
      return [_services.Alert, _services.Auth, _services.Materials, _aureliaRouter.Router];
    };
...
define('modules/problems/problems-creator/problems-creator',['exports', 'config/config', 'models/models', 'services/services', 'simplemde'], function (exports, _config, _models, _services, _simplemde) {
  'use strict';
...
define('modules/problems/problems-creator/problems-editor',['exports', 'aurelia-router', 'config/config', 'models/models', 'services/services', 'simplemde'], function (exports, _aureliaRouter, _config, _models, _services, _simplemde) {
  'use strict';
  ...
  var ViewProblem = exports.ViewProblem = function () {
    ...
    ViewProblem.prototype.activate = function activate(params, routeConfig) {
      ...
      this.problemService.getProblem(this.id).then(function (problem) {
        ...
        console.log(_this.problem.exampleInput);
...
define('modules/syllabus/create-assignment/edit-assignment',['exports', 'aurelia-router', 'config/config', 'models/models', 'services/services'], function (exports, _aureliaRouter, _config, _models, _services) {
  ...
  var EditAssignment = exports.EditAssignment = function () {
    EditAssignment.inject = function inject() {
      return [_services.Alert, _services.Auth, _services.Syllabuses, _aureliaRouter.Router];
    };
    ...
    EditAssignment.prototype.getAssignment = function getAssignment() {
      ...
      this.syllabusService.loadAssignment(this.id).then(function (data) {
        ...
        _this.startDate = _this.assignment.startDate.substr(0, 10);
        _this.endDate = _this.assignment.endDate.substr(0, 10);
        _this.startTime = _this.assignment.startDate.substr(11, 5);
        _this.endTime = _this.assignment.startDate.substr(11, 5);
...
define('modules/syllabus/home-syllabus/home-syllabus',['exports', 'config/config', 'models/models', 'services/services'], function (exports, _config, _models, _services) {
  ...
  var HomeSyllabus = exports.HomeSyllabus = function () {
    HomeSyllabus.inject = function inject() {
    ...
    HomeSyllabus.prototype.getSyllabuses = function getSyllabuses() {
      ...
      this.syllabusService.getSyllabuses(8, this.page, coachId).then(function (data) {
        _this.syllabuses = data.data;
        console.log(_this.syllabuses);
...
define('modules/syllabus/view-assignment/view-assignment',['exports', 'config/config', 'models/models', 'services/services'], function (exports, _config, _models, _services) {
  'use strict';
  ...
  var ViewAssignment = exports.ViewAssignment = function () {
    ViewAssignment.inject = function inject() {
      return [_services.Alert, _services.Auth, _services.Syllabuses];
    };
...
define('text!modules/syllabus/view-assignment/view-assignment.html', ['module'], function(module) { module.exports = "<template>\n    <require from=\"../../../resources/attributes/tooltip\"></require>\n    <div class=\"container ufps-container-logged\">\n      <h1 class=\"text-right\">${assignment.title}</h1>\n      <p class=\"text-right\">${assignment.description}</p>\n      <p class=\"text-right\">${assignment.getStringAvailability()}</p>\n      <hr>\n      <div class=\"col-sm-12\">\n        Ordenar por\n        <div class=\"dropdown dropdown-inline ufps-dropdown\">\n          <button class=\"btn btn-default dropdown-toggle\" type=\"button\" id=\"sortBy\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"true\">\n            ${sortDisplay}\n            <span class=\"caret\"></span>\n            </button>\n          <ul class=\"dropdown-menu ufps-dropdown-menu dropdown-mini\" aria-labelledby=\"sortBy\">\n            <li><a click.delegate=\"setSort('Id')\">Id</a></li>\n            <li><a click.delegate=\"setSort('Dificultad')\">Dificultad</a></li>\n          </ul>\n        </div>\n        en forma\n        <div class=\"dropdown dropdown-inline ufps-dropdown\">\n          <button class=\"btn btn-default dropdown-toggle\" type=\"button\" id=\"orderBy\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"true\">\n            ${byDisplay}\n            <span class=\"caret\"></span>\n            </button>\n          <ul class=\"dropdown-menu ufps-dropdown-menu dropdown-mini\" aria-labelledby=\"orderBy\">\n            <li><a click.delegate=\"setBy('Ascendente')\">Ascendente</a></li>\n            <li><a click.delegate=\"setBy('Descendente')\">Descendente</a></li>\n          </ul>\n        </div>\n      </div>\n      <div class=\"ufps-separator\"></div>\n      <table>\n        <thead>\n          <tr>\n            <th class=\"text-center\" style=\"width:5%\">Id</th>\n            <th class=\"text-center\" style=\"width:70%\">Problema</th>\n            <th class=\"text-center\" style=\"width:10%\">Dificultad</th>\n            <th class=\"text-center\" style=\"width:15%\">Idioma</th>\n          </tr>\n        </thead>\n        <tbody>\n          <tr repeat.for=\"problem of assignment.problemsLoaded\">\n            <td class=\"text-center\">${problem.id}</td>\n            <td class=\"text-left ufps-td-problem\">\n              <p if.bind=\"problem.isInEnglish()\" class=\"ufps-name-problem-list\"><a href=\"#/problemas/${problem.id}/detalle/en\">${problem.titleEN}</a></p>\n              <p if.bind=\"!problem.isInEnglish()\" class=\"ufps-name-problem-list\"><a href=\"#/problemas/${problem.id}/detalle/es\">${problem.titleES}</a></p>\n            </td>\n            <td class=\"text-center\">${problem.level}</td>\n            <td class=\"text-center ufps-language\"><span class=\"${problem.isInSpanish() ? 'active' : 'inactive'}\"><a href=\"#/problemas/${problem.id}/detalle/es\">ES</a></span> | <span class=\"${problem.isInEnglish() ? 'active' : 'inactive'}\"><a href=\"#/problemas/${problem.id}/detalle/en\">EN</a></span></td>\n          </tr>\n        </tbody>\n      </table>\n      <nav aria-label=\"Navegación\" class=\"text-center\">\n        <ul class=\"pagination\">\n          <li class=\"${page === 1 ? 'disabled' : ''}\">\n            <a click.delegate = \"goToFirstPage()\" aria-label=\"Primero\">\n              <span aria-hidden=\"true\">Inicio</span>\n            </a>\n          </li>\n          <li class=\"${page === 1 ? 'disabled' : ''}\">\n            <a click.delegate = \"goToPrevPage()\" aria-label=\"Anterior\">\n              <span aria-hidden=\"true\">Anterior</span>\n            </a>\n          </li>\n          <li repeat.for=\"i of pagination\" class=\"${i === page ? 'active' : ''}\"><a click.delegate = \"goToPage(i)\">${i}</a></li>\n          <li class=\"${page === totalPages ? 'disabled' : ''}\">\n            <a click.delegate = \"goToNextPage()\" aria-label=\"Siguiente\">\n              <span aria-hidden=\"true\">Siguiente</span>\n            </a>\n          </li>\n          <li class=\"${page === totalPages ? 'disabled' : ''}\">\n            <a click.delegate = \"goToLastPage()\" aria-label=\"Último\">\n              <span aria-hidden=\"true\">Final</span>\n            </a>\n          </li>\n        </ul>\n      </nav>\n    </div>\n  -->\n  </template>\n  "; });
