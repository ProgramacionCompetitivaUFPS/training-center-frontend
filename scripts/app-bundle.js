...
define('services/materials',['exports', 'config/config', 'services/http', 'services/jwt'], function (exports, _config, _http, _jwt) {
  ...
  var Materials = exports.Materials = function () {
    ...
    Materials.prototype.getPublicMaterial = function getPublicMaterial() {
...
define('modules/material/public-material/public-material',['exports', 'aurelia-router', 'config/config', 'models/models', 'services/services'], function (exports, _aureliaRouter, _config, _models, _services) {
  ...
  var PublicMaterial = exports.PublicMaterial = function () {
    ...
    PublicMaterial.prototype.getMaterial = function getMaterial() {
      ...
      this.materialService.getPublicMaterial().then(function (data) {
        for (var i = 0; i < data.materials.length; i++) {
          _this.materials.push(new _models.Material(data.materials[i].id, data.materials[i].name));
        }
      }).catch(function (error) {
        if (error.status === 404) {
          _this.alertService.showMessage(_config.MESSAGES.materialDoesNotExist);
