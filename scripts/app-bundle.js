...
define('services/materials',['exports', 'config/config', 'services/http', 'services/jwt'], function (exports, _config, _http, _jwt) {
  ...
  var Materials = exports.Materials = function () {
    ...
    Materials.prototype.getCategoryMaterial = function getCategoryMaterial(idCategory) {
      return this.httpService.httpClient.fetch(_config.API.endpoints.categories + '/' + idCategory + '/' + _config.API.endpoints.materials, {
        method: 'get',
        headers: {
...
define('modules/material/category-material/category-material',['exports', 'aurelia-router', 'config/config', 'models/models', 'services/services'], function (exports, _aureliaRouter, _config, _models, _services) {
  ...
  var CategoryMaterial = exports.CategoryMaterial = function () {
    ...
    CategoryMaterial.prototype.getMaterial = function getMaterial() {
      ...
      this.materialService.getCategoryMaterial(this.id).then(function (data) {
        console.log(data);
  ...
  var SpecificMaterial = exports.SpecificMaterial = function () {
    ...
    SpecificMaterial.prototype.getMaterial = function getMaterial() {
      ...
      this.materialService.getMaterial(this.id).then(function (data) {
        ...
        _this.material = new _models.Material(tmp.id, tmp.name, tmp.number, tmp.description, tmp.url.replace('watch?v=', 'v/'));
      }).catch(function (error) {
        if (error.status === 404) {
          _this.alertService.showMessage(_config.MESSAGES.materialDoesNotExist);
        } else {
