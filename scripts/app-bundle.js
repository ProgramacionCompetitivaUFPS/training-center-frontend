...
define('services/services',['exports', './alert', './auth', './contests', './http', './jwt', './materials', './problems', './syllabuses'], function (exports, _alert, _auth, _contests, _http, _jwt, _materials, _problems, _syllabuses) {
  'use strict';
