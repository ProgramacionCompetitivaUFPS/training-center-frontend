...
define('services/auth',['exports', 'config/config', 'services/alert', 'services/http', 'services/jwt', 'socket.io-client'], function (exports, _config, _alert, _http, _jwt, _socket) {
  'use strict';
  ...
  var Auth = exports.Auth = function () {
    Auth.inject = function inject() {
      return [_http.Http, _alert.Alert, _jwt.Jwt];
    };
    ...
    Auth.prototype.requestRecovery = function requestRecovery(email) {
      return this.httpService.httpClient.fetch(_config.API.endpoints.recovery, {
        method: 'get',
        headers: {
          'Content-Type': 'application/json'
        },
...
define('services/materials',['exports', 'config/config', 'services/http', 'services/jwt'], function (exports, _config, _http, _jwt) {
  'use strict';
  ...
  var Materials = exports.Materials = function () {
    Materials.inject = function inject() {
...
define('services/problems',['exports', 'config/config', 'services/http', 'services/jwt'], function (exports, _config, _http, _jwt) {
  ...
  var Problems = exports.Problems = function () {
    ...
    Problems.prototype.removeProblem = function removeProblem(id) {
      return this.httpService.httpClient.fetch(_config.API.endpoints.problem + '/' + id, {
        method: 'delete',
        headers: {
          'Authorization': 'Bearer ' + this.jwtService.token
        }
    ...
    Problems.prototype.searchProblems = function searchProblems(query, page, limit, sort, by, lang) {
      return this.httpService.httpClient.fetch(_config.API.endpoints.problems + '?search=' + query + '&page=' + page + '&limit=' + limit + '&sort=' + sort + '&by=' + by + '&filter=' + lang, {
        method: 'get',
        headers: {
          'Authorization': 'Bearer ' + this.jwtService.token
        }
...
define('services/services',['exports', './alert', './auth', './contests', './http', './jwt', './materials', './problems', './rankings', './syllabuses'], function (exports, _alert, _auth, _contests, _http, _jwt, _materials, _problems, _rankings, _syllabuses) {
  'use strict';
...
define('modules/search/search',['exports', 'aurelia-framework', 'aurelia-router', 'config/config', 'models/models', 'services/services'], function (exports, _aureliaFramework, _aureliaRouter, _config, _models, _services) {
  ...
  var Search = exports.Search = (_dec = (0, _aureliaFramework.inject)(_services.Alert, _aureliaRouter.Router, _services.Problems), _dec(_class = (_class2 = function () {
    ...
    Search.prototype.getQuery = function getQuery() {
      ...
      this.problemService.searchProblems(this.query, this.page, this.limit, this.sort === 'Nombre' ? 'name' : undefined, this.by === 'Ascendente' ? 'asc' : 'desc', stringLang).then(function (data) {
        _this.totalPages = data.meta.totalPages;
        _this.problems = [];
        if (_this.totalPages > 0) {
          for (var i = 0; i < data.data.length; i++) {
...
define('modules/contest/contest-board/contest-board',['exports', 'aurelia-framework', 'aurelia-router', 'config/config', 'models/models', 'services/services'], function (exports, _aureliaFramework, _aureliaRouter, _config, _models, _services) {
  'use strict';
  ...
  var ContestBoard = exports.ContestBoard = (_dec = (0, _aureliaFramework.inject)(_services.Alert, _services.Auth, _services.Contests, _aureliaRouter.Router), _dec(_class = function () {
    ...
    ContestBoard.prototype.getContest = function getContest() {
      var _this = this;
    ...
    ContestBoard.prototype.getStatus = function getStatus() {
      ...
      this.contestService.getStatus(this.id, this.authService.getUserId()).then(function (data) {
        ...
        if (_this2.status !== 'registered' && !_this2.contest.privacy) {
          _this2.router.navigate('#/maraton/' + _this2.id);
          _this2.alertService.showMessage(_config.MESSAGES.contestBoardNotRegistered);
        }
      }).catch(function (error) {
        if (error.status === 400) {
...
define('modules/contest/contest-detail/contest-detail',['exports', 'aurelia-framework', 'aurelia-router', 'config/config', 'models/models', 'services/services'], function (exports, _aureliaFramework, _aureliaRouter, _config, _models, _services) {
  ...
  var ContestDetail = exports.ContestDetail = (_dec = (0, _aureliaFramework.inject)(_services.Alert, _services.Auth, _services.Contests, _aureliaRouter.Router), _dec(_class = function () {
...
define('modules/contest/contest-problem/contest-problem',['exports', 'aurelia-framework', 'aurelia-router', 'config/config', 'models/models', 'services/services'], function (exports, _aureliaFramework, _aureliaRouter, _config, _models, _services) {
  ...
  var ContestProblem = exports.ContestProblem = (_dec = (0, _aureliaFramework.inject)(_services.Alert, _services.Problems, _aureliaRouter.Router), _dec(_class = function () {
    function ContestProblem(alertService, problemService, routerService) {
    ...
    ContestProblem.prototype.activate = function activate(params, routeConfig) {
      ...
      this.problemService.getProblem(this.id).then(function (problem) {
        ...
        _this.problem = new _models.Problem(parseInt(params.id), problem.title_en, problem.title_es, parseInt(problem.level), parseInt(problem.category), undefined, problem.description_en, problem.description_es, problem.example_input.replace(/\r\n/g, '\n'), problem.example_output.replace(/\r\n/g, '\n'), parseFloat(problem.time_limit), problem.user_id, problem.user.username);
    ...
    ContestProblem.prototype.submit = function submit() {
      ...
      this.problemService.submitSolution(this.id, this.language, undefined, this.contestId, this.code[0]).then(function () {
        _this2.alertService.showMessage(_config.MESSAGES.submittedSolution);
      }).catch(function (error) {
        if (error.status === 401 || error.status === 403) {
          _this2.alertService.showMessage(_config.MESSAGES.permissionsError);
        } else if (error.status === 500) {
...
define('modules/contest/contest-problems/contest-problems',['exports', 'aurelia-framework', 'aurelia-router', 'config/config', 'models/models', 'services/services'], function (exports, _aureliaFramework, _aureliaRouter, _config, _models, _services) {
  ...
  var ContestProblems = exports.ContestProblems = (_dec = (0, _aureliaFramework.inject)(_services.Alert, _services.Auth, _services.Contests, _aureliaRouter.Router), _dec(_class = function () {
...
define('modules/contest/create-contest/create-contest',['exports', 'aurelia-framework', 'aurelia-router', 'config/config', 'models/models', 'services/services'], function (exports, _aureliaFramework, _aureliaRouter, _config, _models, _services) {
  ...
  var CreateContest = exports.CreateContest = (_dec = (0, _aureliaFramework.inject)(_services.Alert, _services.Contests, _aureliaRouter.Router), _dec(_class = function () {
  ...
  var EditContest = exports.EditContest = (_dec = (0, _aureliaFramework.inject)(_services.Alert, _services.Contests, _aureliaRouter.Router), _dec(_class = function () {
    ...
    EditContest.prototype.getContest = function getContest() {
      ...
      this.contestService.getContest(this.id).then(function (data) {
        ...
        _this2.startDate = _this2.contest.initDate.substr(0, 10);
        _this2.endDate = _this2.contest.endDate.substr(0, 10);
        _this2.startTime = _this2.contest.initDate.substr(11, 5);
        _this2.endTime = _this2.contest.endDate.substr(11, 5);
        _this2.getProblems();
      }).catch(function (error) {
        if (error.status === 400) {
          _this2.alertService.showMessage(_config.MESSAGES.contestError);
  ...
  var CategoryProblems = exports.CategoryProblems = (_dec = (0, _aureliaFramework.inject)(_services.Alert, _services.Auth, _services.Problems, _aureliaRouter.Router), _dec(_class = (_class2 = function () {
    ...
    CategoryProblems.prototype.getProblems = function getProblems() {
      ...
      var stringSort = void 0,
          stringLang = void 0;
      if (this.sort === 'Id') stringSort = 'id';else if (this.sort === 'Nombre') stringSort = 'name';else if (this.sort === 'Dificultad') stringSort = 'level';
  ...
  var AssignmentStats = exports.AssignmentStats = (_dec = (0, _aureliaFramework.inject)(_services.Alert, _services.Syllabuses), _dec(_class = (_class2 = function () {
    ...
    AssignmentStats.prototype.getAssignment = function getAssignment() {
      ...
      this.syllabusService.loadAssignment(this.id).then(function (data) {
        _this.assignment = new _models.Assignment(data.assignment.tittle, data.assignment.description, data.assignment.init_date, data.assignment.end_date, undefined, undefined, _this.id);
        _this.assignment.adjuntProblems(data.assignment.problems);
        for (var i = 0; i < _this.assignment.problemsLoaded.length; i++) {
          _this.mapProblem[_this.assignment.problemsLoaded[i].id] = i + 1;
        }
        _this.getResults();
      }).catch(function (error) {
        if (error.status === 401) {
    ...
    AssignmentStats.prototype.getResults = function getResults() {
      ...
      this.syllabusService.loadResults(this.id, this.page).then(function (data) {
        for (var i = 0; i < data.length; i++) {
          if (_this2.mapUsers[data[i].id] === undefined) {
            _this2.mapUsers[data[i].id] = _this2.score.length;
            _this2.score.push([]);
            for (var j = 0; j <= _this2.assignment.problemsLoaded.length + 1; j++) {
              _this2.score[_this2.mapUsers[data[i].id]].push(false);
            }_this2.score[_this2.mapUsers[data[i].id]][0] = data[i].name;
            _this2.score[_this2.mapUsers[data[i].id]][_this2.assignment.problemsLoaded.length + 1] = 0;
          }
          if (data[i].problem_id !== null && !_this2.score[_this2.mapUsers[data[i].id]][_this2.mapProblem[data[i].problem_id]]) {
            _this2.score[_this2.mapUsers[data[i].id]][_this2.mapProblem[data[i].problem_id]] = true;
            _this2.score[_this2.mapUsers[data[i].id]][_this2.assignment.problemsLoaded.length + 1]++;
          }
        }
      }).catch(function (error) {
        if (error.status === 401) {
...
define('modules/syllabus/create-assignment/create-assignment',['exports', 'aurelia-framework', 'aurelia-router', 'config/config', 'models/models', 'services/services'], function (exports, _aureliaFramework, _aureliaRouter, _config, _models, _services) {
  ...
  var CreateAssignment = exports.CreateAssignment = (_dec = (0, _aureliaFramework.inject)(_services.Alert, _services.Syllabuses, _aureliaRouter.Router), _dec(_class = function () {
    ...
    HomeSyllabus.prototype.getEnrolledSyllabuses = function getEnrolledSyllabuses() {
      ...
      this.syllabusService.getEnrolledSyllabuses().then(function (data) {
        for (var i = 0; i < data.user.syllabuses.length; i++) {
          _this2.enrolledSyllabuses.push(_this2.syllabuses[i]);
...
define('modules/syllabus/view-problem/view-problem',['exports', 'aurelia-framework', 'aurelia-router', 'config/config', 'models/models', 'services/services'], function (exports, _aureliaFramework, _aureliaRouter, _config, _models, _services) {
  ...
  var ViewProblem = exports.ViewProblem = (_dec = (0, _aureliaFramework.inject)(_services.Alert, _services.Auth, _services.Problems, _services.Syllabuses, _aureliaRouter.Router), _dec(_class = function () {
    ...
    ViewProblem.prototype.validateDate = function validateDate() {
      ...
      if (this.validDate === 0) {
        interval = setInterval(function () {
          _this.validateSpecificDate();
          if (_this.validateDate == 2) clearInterval(interval);
        }, 10000);
    ...
    ViewProblem.prototype.validateSpecificDate = function validateSpecificDate() {
    ...
    ViewProblem.prototype.activate = function activate(params, routeConfig) {
      ...
      this.problemService.getProblem(this.problemId).then(function (problem) {
        problem = problem.problem;
        _this2.problem = new _models.Problem(parseInt(params.problemId), problem.title_en, problem.title_es, parseInt(problem.level), parseInt(problem.category), undefined, problem.description_en, problem.description_es, problem.example_input.replace(/\r\n/g, '\n'), problem.example_output.replace(/\r\n/g, '\n'), parseFloat(problem.time_limit), problem.user_id, problem.user.username);
    ...
    ViewProblem.prototype.getAssignment = function getAssignment() {
      ...
      this.syllabusService.loadAssignment(this.assignmentId).then(function (data) {
        _this3.startDate = new Date(data.assignment.init_date).getTime();
        _this3.endDate = new Date(data.assignment.end_date).getTime();
        _this3.validateDate();
        _this3.assignment = new _models.Assignment(data.assignment.tittle, data.assignment.description, data.assignment.init_date, data.assignment.end_date, undefined, undefined, _this3.id);
      }).catch(function (error) {
        console.log(error);
        if (error.status === 401) {
          _this3.alertService.showMessage(_config.MESSAGES.permissionsError);
...
define('text!modules/syllabus/view-problem/view-problem.html', ['module'], function(module) { module.exports = "<template>\n  <require from=\"../../../resources/attributes/markdown\"></require>\n  <require from=\"../../../resources/attributes/tooltip\"> </require>\n  <div class=\"container-fluid\">\n    <div class=\"col-md-9\">\n      <div class=\"ufps-separator\"></div>\n      <div class=\"panel panel-default\">\n        <div class=\"panel-body\" show.bind=\"lang === 'es'\">\n          <h1 class=\"text-center ufps-problem-title\">${problem.titleES}</h1>\n          <p class=\"ufps-language text-center\">\n            <span class=\"${problem.isInSpanish() ? 'active' : 'inactive'}\" click.delegate=\"showES()\">ES</span> | <span class=\"${problem.isInEnglish() ? 'active' : 'inactive'}\"\n              click.delegate=\"showEN()\">EN</span>\n          </p>\n          <p class=\"ufps-markdown-editor\" markdown.bind=\"problem.descriptionES\"></p>\n          <div class=\"col-xs-12\">\n            <div class=\"col-md-6\">\n              <h3 class=\"text-center\">Entrada de ejemplo</h3>\n              <div class=\"well example-in-out\">\n                <pre>${problem.exampleInput}</pre>\n              </div>\n            </div>\n            <div class=\"col-md-6\">\n              <h3 class=\"text-center\">Salida de ejemplo</h3>\n              <div class=\"well example-in-out\">\n                <pre>${problem.exampleOutput}</pre>\n              </div>\n            </div>\n          </div>\n        </div>\n        <div class=\"panel-body\" show.bind=\"lang === 'en'\">\n          <h1 class=\"text-center ufps-problem-title\">${problem.titleEN}</h1>\n          <p class=\"ufps-language text-center\">\n            <span class=\"${problem.isInSpanish() ? 'active' : 'inactive'}\" click.delegate=\"showES()\">ES</span> | <span class=\"${problem.isInEnglish() ? 'active' : 'inactive'}\"\n              click.delegate=\"showEN()\">EN</span>\n          </p>\n          <p class=\"ufps-markdown-editor\" markdown.bind=\"problem.descriptionEN\"></p>\n          <div class=\"col-xs-12\">\n            <div class=\"col-md-6\">\n              <h3 class=\"text-center\">Entrada de ejemplo</h3>\n              <div class=\"well example-in-out\">\n                <pre>${problem.exampleInput}</pre>\n                \n              </div>\n            </div>\n            <div class=\"col-md-6\">\n              <h3 class=\"text-center\">Salida de ejemplo</h3>\n              <div class=\"well example-in-out\">\n                <pre>${problem.exampleOutput}</pre>\n              </div>\n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n    <div class=\"col-md-3\">\n      <div class=\"ufps-separator\"></div>\n      <div class=\"panel panel-default\">\n        <div class=\"panel-body\">\n          <p show.bind=\"lang === 'en'\"><strong>Problema:</strong> ${problem.titleEN}</p>\n          <p show.bind=\"lang === 'es'\"><strong>Problema:</strong> ${problem.titleES}</p>\n          <p><strong>Dificultad:</strong> ${problem.level}</p>\n          <p if.bind=\"validDate === 1\"><strong>Esta tarea aún no puede ser enviada.</strong> ${assignment.getStringAvailability().replace('Disponible', 'Estará disponible')}</p>\n          <p if.bind=\"validDate === 2\"><strong>Esta tarea ya no puede ser enviada.</strong> ${assignment.getStringAvailability().replace('Disponible', 'Estuvo disponible')}</p>\n          <p>Seleccione el archivo con su código, y el lenguaje a utilizar.</p>\n          <form class=\"ufps-submit-form\" submit.delegate=\"submit()\"  enctype=\"multipart/form-data\">\n            <input type=\"file\" name=\"input-file\" id=\"input-file\" class=\"inputfile-btn\" change.delegate=\"validateCode()\"  accept=\".py, .java, .cpp\" files.bind=\"code\"  disabled.bind=\"validDate > 0\">\n            <label for=\"${validDate > 0 ? '' : 'input-file'}\" tooltip data-toggle=\"tooltip\" title=\"Archivo con la solución al problema\" class=\"${validDate > 0 ? 'disabled-select' : ''}\">Seleccionar <span class=\"glyphicon glyphicon-ok-sign\" show.bind=\"sourceValid\"></span></label>\n            <div class=\"input-group\">\n              <select class=\"form-control\" value.bind=\"language\" disabled.bind=\"validDate > 0\">\n                <option required model.bind=\"null\">Lenguaje...</option>\n                <option repeat.for=\"lg of languages\" model.bind=\"lg\">${lg}</option>\n              </select>\n            </div>\n            <input type=\"submit\" value=\"Enviar\" class=\"btn ufps-btn-submit btn-disabled\" disabled.bind=\"validDate > 0\">\n          </form>\n        </div>\n      </div>\n    </div>\n  </div>\n</template>\n"; });
